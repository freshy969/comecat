...
import robocatImage from '../../../assets/img/robocat.png'
...
class RoomInfo extends Component {
    ...
    setBotStatus = (enabled) => {
        ...
        this.props.setBotStatus(this.props.room._id, enabled);
    ...
    render() {
        ...
        return (
            <div>
                ...
                {this.props.room.botAvailable ? <div>

                    {this.props.room.botEnabled === 1 ?
                        <div className="robot-status on">
                            <img src={robocatImage} />
                            {strings.InfoViewBotStatusActive[user.lang]}
                            <button className="btn btn-xs btn-round btn-secondary" onClick={e => this.setBotStatus(0)}>{strings.InfoViewBotOff[user.lang]}</button>
                        </div> :

                        <div className="robot-status off">
                            <img src={robocatImage} />
                            {strings.InfoViewBotStatusIdle[user.lang]}
                            <button className="btn btn-xs btn-round btn-danger" onClick={e => this.setBotStatus(1)}>{strings.InfoViewBotOn[user.lang]}</button>
                        </div>
                    }
                </div> : null}
                        ...
                        <div className="quickview-block form-type-material">
                            ...
                            <div className="media-list media-list-hover">
                                ...
                                {membersModified.map(member => {
                                    ...
                                    return <div className="media media-single media-action-visible" key={member._id} >
...
const mapDispatchToProps = (dispatch) => {
    return {
        ...
        setBotStatus: (roomId, status) => dispatch(actions.room.setBotStatus(roomId, status)),
