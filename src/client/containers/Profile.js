                                ...
                                <div className="card-body p-20">
                                    ...
                                    {!this.props.avatarImage ?
                                        <div>
                                            ...
                                            <div className="input-group">
                                                <input type="file" name="file" className="form-control" onChange={e => { this.props.selectFile(e.target.files[0]) }} accept="image/*" />
                                            </div>
                                        </div> : null
                                    }
                                    ...
                                    {this.props.coverImage ?
                                        <div className="media flex-column b-1 p-0">
                                            <div className="flexbox bg-pale-secondary bt-1 border-light px-12 py-10">
                                                <span className="flex-grow">{this.props.coverImage.name}</span>
                                                <a className="media-action" href="javascript:void(0)" title="Delete" onClick={this.props.deleteFileCover}><i className="ti-close"></i></a>
                                            </div>
                                            <span className="m-auto">
                                                <img className="m-1 b-1 img-fluid h-250px " src={this.props.coverImageUrl} />
                                            </span>
                                        </div> : null
                                    }
                                    ...
                                    {!this.props.coverImage ?
                                        <div>
                                            <label>{strings.ProfileCover[user.lang]}</label>
                                            <div className="input-group">
                                                <input type="file" name="cover" className="form-control" onChange={e => { this.props.selectFileCover(e.target.files[0]) }} accept="image/*" />
                                            </div>
                                        </div> : null
                                    }
                                    ...
                                    {this.props.bgImage ?
                                        <div className="media flex-column b-1 p-0">
                                            <div className="flexbox bg-pale-secondary bt-1 border-light px-12 py-10">
                                                <span className="flex-grow">{this.props.bgImage.name}</span>
                                                <a className="media-action" href="javascript:void(0)" title="Delete" onClick={this.props.deleteFileBg}><i className="ti-close"></i></a>
                                            </div>
                                            <span className="m-auto">
                                                <img className="m-1 b-1 img-fluid h-250px " src={this.props.bgImageUrl} />
                                            </span>
                                        </div> : null
                                    }
                                    ...
                                    {!this.props.bgImage ?
                                        <div>
                                            <label>{strings.ProfileBackground[user.lang]}</label>
                                            <div className="input-group">
                                                <input type="file" name="bg" className="form-control" onChange={e => { this.props.selectFileBg(e.target.files[0]) }} accept="image/*" />
                                            </div>
                                        </div> : null
                                    }
...
const mapStateToProps = (state) => {
    return {
        ...
        bgImage: state.profile.bgImage,
        bgImageUrl: state.profile.bgImageUrl,
...
const mapDispatchToProps = (dispatch) => {
    return {
        ...
        selectFileCover: (val) => dispatch(actions.profile.selectFileCover(val)),
        deleteFileCover: (val) => dispatch(actions.profile.deleteFileCover(val)),

        selectFileBg: (val) => dispatch(actions.profile.selectFileBg(val)),
        deleteFileBg: (val) => dispatch(actions.profile.deleteFileBg(val)),
