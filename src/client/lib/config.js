...
export const vapidPublicKey = "BDxUTeFBXMq2TcGDgZidENjxWl_5wSBrsXjbl5mQNzkib4XovLJWnWnbu6tOjlYQh9w8OtRT3eDznPO_upspmwY";

export const PaymentDemoMode = 'N'

export const checkoutURL = {
}

export const PaymentSID = {
}

export const PaymentRedirectURL = ''