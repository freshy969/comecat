...
export const ApiUrlCheckCode = "/user/signin/activate";
export const ApiUrlSignUp = "/user/signup/email";
export const ApiUrlForget = "/user/forget";
...
export const ApiUrlLoadDefaultWebConnector = "/connector/default";
export const ApiUrlLoadDefaultApiKey = "/apikey";
export const ApiUrlResetApiKey = "/apikey/reset";
export const ApiUrlSaveWebhookURL = "/webhook";
export const ApiUrlGetWebhookURL = "/webhook";
export const ApiUrlLoadGetSocialConnector = "/connector/service";
export const ApiUrlSaveSocialSettings = "/connector/service";
export const ApiUrlLoadChatBotSettings = "/chatbot";
export const ApiUrlSaveChatBotSettings = "/chatbot";
export const ApiUrlGetAllEnabledBot = "/chatbot/all";
export const ApiUrlSaveBotForConnector = "/connector/service/bot";
export const ApiUrlEnableBot = "/room/bot";
export const ApiUrlLoadUsage = "/user/usage";
export const ApiUrlSaveWebPushSubscription = "/user/savewebpushsubscription";
export const ApiUrlGetPaymentHistory = "/payment/history";
...
export const IntegrationStateEnabled = 1;
export const IntegrationStateWaiting = 2;

export const UsageTypeFree = 1;
export const UsageTypePaid = 2;
