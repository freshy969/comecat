...
var BackendMain = {
    ...
    init: function (app) {
        ...
        router.use("/user/forget", require("./Controllers/User/ForgetController").init(app));
        ...
        router.use("/connector", require("./Controllers/Integration/GetDefaultWebConnectorController").init(app));
        router.use("/apikey", require("./Controllers/Integration/ApiKeyController").init(app));
        router.use("/webhook", require("./Controllers/Integration/WebhookController").init(app));
        router.use("/connector/service", require("./Controllers/Integration/ServiceConnectorController").init(app));
        router.use("/chatbot", require("./Controllers/Integration/ChatbotController").init(app));
        router.use("/room/bot", require("./Controllers/Room/EnableBotController").init(app));
        router.use("/user/usage", require("./Controllers/User/GetUsageController").init(app));

        router.use("/payment/checkout-redirect", require("./Controllers/Payment/CheckoutRedirect").init(app));
        router.use("/payment/webhook/", require("./Controllers/Payment/WebhookReceiver").init(app));
        router.use("/payment/history/", require("./Controllers/Payment/GetPaymentHistory").init(app));
        return router;
    }
}
