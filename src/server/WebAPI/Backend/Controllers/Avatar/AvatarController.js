    ...
    router.get('/user/:fileID', function (request, response) {
        ...
        fs.exists(filePath, function (exists) {
            ...
            if (!exists) {
                ...
                const firstLetter = fileID.charCodeAt(fileID.length - 1).toString(16).substring(1, 2);
                filePath = Config.publicPath + "/images/defaultAvatars/comecat_" + firstLetter + ".jpg";
                response.sendFile(filePath);
