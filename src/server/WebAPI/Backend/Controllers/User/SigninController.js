...
SigninController.prototype.init = function (app) {
      ...
      * @apiSuccessExample Success-Response:
 {
    ...
    router.post('/activate', function (request, response) {
        ...
        if (_.isEmpty(request.body.code)) {
            self.successResponse(response, Const.responsecodeSigninNoActivationCode);
            return;
        }

        const activationCode = request.body.code;
        ...
        async.waterfall([
            ...
            function (done) {
                ...
                // get organization 
                organizationModel.findOne({ organizationId: Config.personamOrganizationName }, function (err, findResult) {
    ...
    router.post('', function (request, response) {
        ...
        var organizationid = Config.personamOrganizationName;
