...
SignupController.prototype.init = function (app) {
    ...
    /**
  * @api {post} /api/v2/user/signup/sendEmail Signup Send Email
  * @apiName Signup Send Email
  * @apiGroup WebAPI
  * @apiDescription Send Email verification code to user
  *   
        ...
        function checkEmail(result, done) {
            ...
            userModel.findOne({
                ...
                if (findResult) {
                    ...
                    Utils.sendEmail(
                        email,
                        '[come.cat] Check Activation Code',
                        'Please click this link.\n http://dev.come.cat/signin/verifycode/' + activationCode,
                        (err, emailResult) => {
                    ...
                    */
                    ...
                    Utils.sendEmail(
                        email,
                        '[come.cat] Check Activation Code',
                        'Please click this link.\n http://dev.come.cat/signup/activate/' + activationCode,
                        (err, emailResult) => {
            ...
            if (result.registeredUser) {
                ...
                userModel.update(
                    ...
                    (err, updateResult) => {
                        ...
                        Utils.sendEmail(
                            email,
                            Const.emailTypeSignUp,
                            {
                                email: email,
                                activateionURL: Config.serviceURL + '/activate/' + activationCode
                            },
                            (err, emailResult) => {
                ...
                var data = {
                    ...
                    created: Utils.now(),
                    subscription: Const.subscriptions.free,
                    status: 0
                }
