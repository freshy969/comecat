        ...
        async.waterfall([
            ...
            function (result, done) {
                ...
                model.findOne({ _id: _id }, function (err, findResult) {
                    ...
                    result.obj = findResult.toObject();
                    done(err, result);
            ...
            function (err, result) {
                ...
                if (result.obj.sandbox) {
                    templateParams.formValues.sandbox = 1;
                } else {
                    templateParams.formValues.sandbox = 0;
                }
    ...
    router.post('/edit/:_id', checkUserAdmin, function (request, response) {
        ...
        async.waterfall([
            ...
            function (result, done) {
                ...
                var sandbox = false;
                if (templateParams.formValues.sandbox === '1')
                    sandbox = true;
                ...
                var updateParams = {
                    ...
                    subscription: templateParams.formValues.subscription,
